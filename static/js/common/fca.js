define(function(require, exports) {
    ...
    var tmpl = '<div class="field clearfix">' +
        '     <label>所在省:</label>' +
        '     <select class="province_select" name="province_code" data-required="请添加省">' +
        ...
        '     <label>所在市:</label>' +
        '     <select class="city_select" name="city_code" data-required="请添加市">' +
        '         <option value="">不限</option>' +
        ...
        '<div class="field clearfix">' +
        '     <label>所在区:</label>' +
        '     <select  class="area_select" name="area_code" data-required="请添加区县">' +
        '         <option value="">不限</option>' +
