    ...
    function bindEvents() {
        ...
        var eventsObj = {
            'goActivity':function(){
                ...
                if (params.isapp==1) {
                    if (params._vt) {
                        var url = API.mdomain+"/luckyInfo1.html?id="+aid+"&pid="+pid+"&_vt="+params._vt+"&isapp=1";
                        window.location.href=url;
                        //jsInterface.pushH5URL(url);                         
                    } else{
                        var url = API.mdomain+"/luckyInfo1.html?id="+aid+"&pid="+pid+"&isapp=1";
                        window.location.href=url;
                        //jsInterface.pushH5URL(url); 
                    };
                } else{
                    var url = API.mdomain+"/luckyInfo1.html?id="+aid+"&pid="+pid;
                    window.location.href=url;
                };
            }
        }
