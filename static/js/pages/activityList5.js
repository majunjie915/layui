    ...
    function bindEvents() {
        ...
        var eventsObj = {
            'goActivity':function(){
                ...
                if (params.isapp==1) {
                    if (params._vt) {
                        var url = API.mdomain+"/luckyInfo5.html?id="+aid+"&_vt="+params._vt+"&isapp=1";
                        jsInterface.pushH5URL(url);                         
                    } else{
                        var url = API.mdomain+"/luckyInfo5.html?id="+aid+"&isapp=1";
                        jsInterface.pushH5URL(url); 
                    };
                } else{
                    var url = API.mdomain+"/luckyInfo5.html?id="+aid;
