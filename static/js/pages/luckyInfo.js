define(function(require, exports) {    
    ...
    function getInfoData() {
        ...
        var successFn = function(res) {
            ...
            // $(".topImg").html('<img src="'+result.data.erect_pic+'">');
            //$(".topImg img").attr("lazy-img", result.data.erect_pic);
            ...
            $(".footerLeft").click(function(){
                ...
                if (isapp==1) {
                    // if (params['_vt']) {
                        if (result.data.pro_id==1) {
                            // jsInterface.requestTicketData(scene_id);
                            jsInterface.showTicketWithProgramIDSceneID(scene_id,"");
                        }else{
                            $(".toast").show();
                            setTimeout(function(){
                                $(".toast").hide();
                    ...
                    // if (LS.get("_vt")) {
                        if (result.data.pro_id==1) {
                            // window.location.href = "./gobuy.html?scencid="+scene_id;                       
                            window.location.href = "./activeDetail.html?id="+scene_id;                       
                        }else{
                            $(".toast").show();
                            setTimeout(function(){
                                $(".toast").hide();
                    ...
                    // }else{
                    //     window.location.href = "../../logon.html?r=10&id="+result.data.id;
                    // }
                }
            });            
            if (isapp==1) {
    ...
    $("#footerRight").click(function(){
        if (LS.get('isclick')=='0') {
            ...
            // 
            if (isapp==1) {
                var link = API.mdomain+'/luckyInfo.html?id='+params['id'];
                if (params["_vt"]) {
